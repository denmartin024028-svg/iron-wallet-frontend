    ...
    <div className="min-h-screen bg-void flex items-center justify-center px-6 py-12">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl md:text-4xl font-bold font-['Outfit'] text-white mt-8">Create Account</h1>
          <p className="text-white/70 mt-2">Start your investment journey today</p>
        </div>
